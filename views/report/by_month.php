...
<legend>Laporan Lawatan Mengikut Bulan</legend>

<form method="post" action="index.php?r=report/by-month">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
...
<div class="col-md-4">
    <table class="table table-bordered">
        ...
        foreach ($rs as $r) :
            ?>
            <tr>
                <td><?= MyDate::monthName($r['month']) ?></td>
                <td><?= $r['bil'] ?></td>
            </tr>
            <?php
        endforeach;
